...
'***************************************************************************
*/
 #ifndef Q7B_declare_h
#define Q7B_declare_h

#include "Q7BRuntime.h"


class Declare;
extern Declare *Q7B_Declare_Class(Q7B o);
extern Q7B Q7B_Declare_Object();
extern Declare *q7b_Declare_Object;
extern Q7B q7b_Declare_Object_Q7B;
extern bool q7b_Declare_Object_Finalized;
extern bool q7b_Declare_Object_Init;
...
class Declare : public Module
{
Q_OBJECT
public:
Declare(QObject *parent = 0);
~Declare();
Declare(Q7B _q7b_this);
void Init();



public:
static void SingleTonInit(Declare*me)
{
q7b_Declare_Object = me;
q7b_Declare_Object_Q7B = me->q7b_this;
q7b_Declare_Object_Init = true;
me->Init();
}
...
return q7b_Declare_Object_Q7B;
}


static Declare* SingleTonObjectPointer()
{
if (q7b_Declare_Object_Finalized) return 0;
if (q7b_Declare_Object == 0){
q7b_Declare_Object_Init = true;
q7b_Declare_Object = new Declare(q7b_Declare_Object_Q7B);
q7b_Declare_Object->Init();
}
return q7b_Declare_Object;
}


static Declare* ClassPointer(Q7B o)
{
return (Declare*) o->ref;
}
