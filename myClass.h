...
'***************************************************************************
*/
 #ifndef Q7B_myclass_h
#define Q7B_myclass_h

#include "Q7BRuntime.h"


class myClass;
extern myClass *Q7B_myClass_Class(Q7B o);
extern Q7B Q7B_myClass_Object();
extern myClass *q7b_myClass_Object;
extern Q7B q7b_myClass_Object_Q7B;
extern bool q7b_myClass_Object_Finalized;
extern bool q7b_myClass_Object_Init;
...
~myClass();
myClass(Q7B _q7b_this);
void Init();



public:
static void SingleTonInit(myClass*me)
{
q7b_myClass_Object = me;
q7b_myClass_Object_Q7B = me->q7b_this;
q7b_myClass_Object_Init = true;
me->Init();
}
...
return q7b_myClass_Object_Q7B;
}


static myClass* SingleTonObjectPointer()
{
if (q7b_myClass_Object_Finalized) return 0;
if (q7b_myClass_Object == 0){
q7b_myClass_Object_Init = true;
q7b_myClass_Object = new myClass(q7b_myClass_Object_Q7B);
q7b_myClass_Object->Init();
}
return q7b_myClass_Object;
}


static myClass* ClassPointer(Q7B o)
{
return (myClass*) o->ref;
}
