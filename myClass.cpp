...
myClass *Q7B_myClass_Class(Q7B o){ return myClass::ClassPointer(o); }
Q7B Q7B_myClass_Object(){ return myClass::SingleTonObject(); }
myClass *q7b_myClass_Object = 0;
Q7B q7b_myClass_Object_Q7B;
bool q7b_myClass_Object_Finalized = false;
bool q7b_myClass_Object_Init = false;
...
myClass::~myClass()
{
  if (this == q7b_myClass_Object){ q7b_myClass_Object = 0; q7b_myClass_Object_Q7B = Q7B_IDNIL(); }
  q7b_this->ref = 0;
}

myClass::myClass(Q7B _q7b_this)
{
  q7b_this = _q7b_this;
}
...
void myClass::Init()
{
  if (q7b_myClass_Object_Init){ q7b_myClass_Object_Init = false; q7b_myClass_Object_Q7B = q7b_this = Q7B(new Q7B_id(typeid(myClass).name(), this)); } else q7b_this = Q7B(new Q7B_id(typeid(myClass).name(), this)); 
  setObjectName("myClass");
}
